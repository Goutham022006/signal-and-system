...
\begin{lstlisting}
$https://github.com/Goutham022006/signal-and-system/blob/master/Signals%20and%20systems/Audio_filter/codes/song.wav
\end{lstlisting}
...
There are a lot of yellow lines between 440 Hz to 11KHz.  These represent the synthesizer key tones. Also, the key strokes are audible along with background noise.\\
\begin{figure}[H]
	\centering
...
\\
\solution The key strokes as well as background noise is subdued in the audio.  Also,  the signal is blank for frequencies above 11 kHz.
\begin{figure}[H]
	\centering
...
\begin{lstlisting}
https://github.com/Goutham022006/signal-and-system/blob/master/Signals%20and%20systems/Audio_filter/codes/3.c
\end{lstlisting} 
The following code plots \eqref{prob:2.1} and \eqref{prob:2.2}
\begin{lstlisting}
https://github.com/Goutham022006/signal-and-system/blob/master/Signals%20and%20systems/Audio_filter/codes/3.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Goutham022006/signal-and-system/blob/master/Signals%20and%20systems/Audio_filter/codes/4.5.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Goutham022006/signal-and-system/blob/master/Signals%20and%20systems/Audio_filter/codes/5.2.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Goutham022006/signal-and-system/blob/master/Signals%20and%20systems/Audio_filter/codes/hndef.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
...
%
\begin{lstlisting}
https://github.com/Goutham022006/signal-and-system/blob/master/Signals%20and%20systems/Audio_filter/codes/5.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Goutham022006/signal-and-system/blob/master/Signals%20and%20systems/Audio_filter/codes/6.123.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Goutham022006/signal-and-system/blob/master/Signals%20and%20systems/Audio_filter/codes/6.4.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Goutham022006/signal-and-system/blob/master/Signals%20and%20systems/Audio_filter/codes/6.5.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Goutham022006/signal-and-system/blob/master/Signals%20and%20systems/Audio_filter/codes/7.1.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\begin{lstlisting}
https://github.com/Goutham022006/signal-and-system/blob/master/Signals%20and%20systems/Audio_filter/codes/7.2.py
\end{lstlisting}
...
\begin{lstlisting}
https://github.com/Goutham022006/signal-and-system/blob/master/Signals%20and%20systems/Audio_filter/codes/filter_response.py
\end{lstlisting}
\begin{figure}[H]
\centering
...
\\
\solution The given butterworth filter is lowpass with order=4 and cutoff-frequency=11kHz.
